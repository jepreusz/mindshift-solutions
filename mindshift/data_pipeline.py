# top level script to orchestrate data pre-processing and processing
...
class DataPipeline:
    ...
    def preprocess_data(self, data):
        return self.datafilter.rm_stopwords(data)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--preprocess', '-p', action='store_true', type=bool, help='pre-process data? [True|False]')
    ...
    if args.task == 'show':
        ...
        clean_data = df.apply(pipeline.preprocess_data)
        print(clean_data)
